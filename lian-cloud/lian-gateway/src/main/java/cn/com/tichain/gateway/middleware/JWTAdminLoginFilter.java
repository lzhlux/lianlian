...
import cn.com.tichain.gateway.mdel.*;
...
@Component
class JWTAdminLoginFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public JWTAdminLoginFilter(AuthenticationManager authenticationManager) {
        super(new AntPathRequestMatcher("/api/v1/admin/login"));
    ...
    public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)throws AuthenticationException, IOException, ServletException {
        ...
        try {
            ...
            // 验证登录
            AccountDTO accountDto = accountService.adminlogin(req, creds);
